...
# predict the first element from training dataset as a test
feautures_sample =  np.array([np.array([1.24e+03, 3.00e+00, 1.00e+00, 6.40e+01])])
X_transformed = scaler.transform(feautures_sample)
y_sample_pred_sgd = sgdr.predict(X_transformed)
...
for i in range(len(ax)):
    ...
    ax[i].scatter(feautures_sample[0][i], y_sample_pred_sgd, c='r', marker='x', label="sample")
ax[0].set_ylabel("Price"); ax[0].legend()
fig.suptitle("target vs prediction using z-score normalized model. Sklearn")
plt.show()
