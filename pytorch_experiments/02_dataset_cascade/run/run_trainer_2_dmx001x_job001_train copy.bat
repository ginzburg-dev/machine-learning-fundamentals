...
--weights-out ml_denoiser\output\jobs\job_02_004\trainer_2_dmx001x_train3_weights.pt ^
--epochs 240 ^
--batch-size 8 ^
...
--weights-in ml_denoiser\output\jobs\job_02_004\trainer_2_dmx001x_train3_weights.pt

rem ===================== APPLY =====================
call tools\wrappers\submit_train_job.bat apply pytorch_experiments\experements\02_dataset_cascade\trainer_2_dmx001x.py ^
--mode apply ^
--input C:\Users\ginzb\YandexDisk\TGB_train_dataset\TGB1311220 ^
--output ml_denoiser\output\jobs\job_02_003\ ^
--weights-in ml_denoiser\output\jobs\job_02_003\trainer_2_dmx001x_train3_weights_best.pt

endlocal

echo Starting TensorBoard...
tensorboard --logdir C:\Ginzburg\Production\Development\machine-learning-fundamentals\ml_denoiser\output\jobs\job_02_004\tensorboard_logs --port 6006
pause